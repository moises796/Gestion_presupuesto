    ...
    public class PersonalVoboController : Controller
    {
        ...
        public ActionResult PersonalVobo()
        {
            ...
            if (user != null)
            {
                ...
                var acceso = db.menu.FirstOrDefault(x => x.accion == "PersonalVobo" && x.controlador == "PersonalVobo" && x.estado == 1);
                if (acceso != null)
                {
                ...
                else
                {
                    ...
                    var acceso_submenu = db.sub_menu.FirstOrDefault(x => x.accion == "PersonalVobo" && x.controlador == "PersonalVobo" && x.estado == 1);
